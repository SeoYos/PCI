...
font = ImageFont.truetype('/usr/share/fonts/truetype/takao-gothic/TakaoGothic.ttf',10,encoding='unic')
...
def drawnode(draw,clust,x,y,scaling,labels):
    if clust.id<0:
        ...
        # 終点であればアイテムのラベルを描く
        draw.text((x+5,y-7),labels[clust.id],font=font,fill=(0,0,0))
